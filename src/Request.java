...
public class Request extends JPanel{
    ...
    public JTextArea requestWrite = new JTextArea(); //요청 사항 텍스트

    public JButton order = new JButton("주문");//주문 버튼
    public JButton cancel = new JButton("취소");//취소 버튼

    public JButton choicePay1 = new JButton("QR 결제");//카드 결제 버튼
    ...
    public Request() {
        ...
        requestLabel.setBounds(525,0,525,20);//요청사항라벨
        add(requestLabel);
        requestWrite.setFont(new Font("맑은 고딕",Font.BOLD,22));
        JScrollPane scrollRequest = new JScrollPane(requestWrite);//요청 사항 스크롤 생성
        scrollRequest.setBounds(525,20,525,110);//스크롤 텍스트 위치,크기
        add(scrollRequest);

        choicePay1.setBounds(525,130,262,30);//카드 결제 버튼
        add(choicePay1);
